...
RubyReplacerNarouToKakuYomu.html converts ruby notation of the Japanese novel site, "Narou" to the another Japanese novel site, "Kakuyomu".

RubyReplacerNarouAndKakuYomuToAlphaPolis.html converts ruby notation of the Japanese novel site, "Narou" and the another Japanese novel site, "Kakuyomu" to the other Japanese novel site, "Alphapolis".
...
　RubyReplacerNarouToKakuYomu.htmlで「小説家になろう」の半角括弧()のルビ記法を「カクヨム」の二重山括弧《》のルビ記法に置換できます。

　RubyReplacerNarouAndKakuYomuToAlphaPolis.htmlで「小説家になろう」の半角括弧()のルビ記法と「カクヨム」の二重山括弧《》のルビ記法を「アルファポリス」の全角縦線と二重山括弧《》のルビ記法に置換できます。
