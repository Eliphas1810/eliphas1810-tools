...
def convert():
    try:
        ...
        with open(os.path.join(out_dir, "content.xml"), "w", encoding="utf-8", newline="\n") as file:
            ...
            file.write('        <style:font-face style:name="Noto Sans CJK JP" svg:font-family="&apos;Noto Sans CJK JP&apos;" style:font-family-generic="swiss" style:font-pitch="variable" />\n')
            ...
            file.write('        <style:font-face style:name="Noto Serif CJK JP" svg:font-family="&apos;Noto Serif CJK JP&apos;" style:font-family-generic="system" style:font-pitch="variable"/>\n')
            file.write('    </office:font-face-decls>\n')
            ...
            file.write('            <style:text-properties style:font-name-asian="Noto Serif CJK JP" />\n')
